        ...
        >
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1">Sales Comm. (%)</label>
                        <input
                            type="number"
                            min="0"
                            step="0.1"
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1">Supervision Comm. (%)</label>
                        <input
                            type="number"
                            min="0"
                            step="0.1"
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="canManageCommissions" className="text-sm font-medium text-gray-700">
