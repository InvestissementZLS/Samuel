...
import { verifyBookingToken, confirmBooking, getClientServices } from "@/app/actions/booking-actions";
...
export default function ClientBookingPage({ params }: { params: { token: string } }) {
    ...
    const handleServiceSelect = async (service: any) => {
        ...
        if (selectedPropertyId) {
            ...
            try {
                const slots = await findSmartSlots(service.id, selectedPropertyId);
    ...
    if (!clientData) return <div className="p-8 text-center text-red-500">Invalid or Expired Link</div>;
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-2xl w-full bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-blue-600 p-6 text-white">
                    ...
                    <p className="opacity-90">Welcome, {clientData.name}</p>
                </div>
                ...
                <div className="p-6">
                    {/* Location Confirm */}
                    {clientData.properties.length > 1 && step < 3 && (
                        <div className="mb-6">
